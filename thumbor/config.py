...
Config.define('MAX_PIXELS', 75e6, 'Max pixel count for images read by thumbor',
              'Imaging')
...
Config.define(
    'ALLOWED_SOURCES', [], 'Allowed domains for the http loader to download. '
    'These are regular expressions.', 'Imaging')

Config.define('QUALITY', 80, 'Quality index used for generated JPEG images',
              'Imaging')

Config.define('PROGRESSIVE_JPEG', True,
              'Exports JPEG images with the `progressive` flag set.', 'Imaging')
...
Config.define('PNG_COMPRESSION_LEVEL', 6,
              'Compression level for generated PNG images.', 'Imaging')
...
Config.define(
    ...
    'Indicates the Max AGE header in seconds for temporary images'
    '(images with failed smart detection)', 'Imaging')
...
Config.define(
    ...
    'Ignore errors during smart detections and return image as '
    'a temp image (not saved in result storage and with '
...
Config.define(
    ...
    'Increases image size in kbytes, use with caution.', 'Imaging')

Config.define(
    'ALLOW_ANIMATED_GIFS', True,
    'Indicates whether thumbor should enable the EXPERIMENTAL '
    'support for animated gifs.', 'Imaging')
...
Config.define(
    'USE_BLACKLIST', False, 'Indicates whether thumbor should enable blacklist '
    'functionality to prevent processing certain images.', 'Imaging')
...
Config.define(
    ...
    'Increase this if you are seeing your IOLoop getting blocked '
    '(often indicated by your upstream HTTP requests timing out)', 'Imaging')
...
Config.define(
    ...
    'The gif engine thumbor should use to perform image '
    'operations. This must be the full name of a '
    'python module (python must be able to import it)', 'Extensibility')

Config.define('SECURITY_KEY', 'MY_SECURE_KEY',
              'The security key thumbor uses to sign image URLs', 'Security')

Config.define('ALLOW_UNSAFE_URL', True,
              'Indicates if the /unsafe URL should be available', 'Security')

Config.define('ALLOW_OLD_URLS', True,
              'Indicates if encrypted (old style) URLs should be allowed',
              'Security')

Config.define('ENABLE_ETAGS', True, 'Enables automatically generated etags',
              'HTTP')

Config.define('MAX_ID_LENGTH', 32,
              'Set maximum id length for images when stored', 'Storage')

Config.define('GC_INTERVAL', None, 'Set garbage collection interval in seconds',
              'Performance')
...
Config.define('STATSD_PORT', 8125, 'Port to send statsd instrumentation to',
              'Metrics')

Config.define('STATSD_PREFIX', None, 'Prefix for statsd', 'Metrics')

# FILE LOADER OPTIONS
Config.define('FILE_LOADER_ROOT_PATH', HOME,
...
Config.define('HTTP_LOADER_DEFAULT_USER_AGENT', 'Thumbor/%s' % __version__,
              'Default user agent for thumbor http loader requests',
              'HTTP Loader')

Config.define('HTTP_LOADER_PROXY_HOST', None,
              'The proxy host needed to load images through', 'HTTP Loader')

Config.define('HTTP_LOADER_PROXY_PORT', None,
              'The proxy port for the proxy host', 'HTTP Loader')

Config.define('HTTP_LOADER_PROXY_USERNAME', None,
              'The proxy username for the proxy host', 'HTTP Loader')

Config.define('HTTP_LOADER_PROXY_PASSWORD', None,
              'The proxy password for the proxy host', 'HTTP Loader')

Config.define('HTTP_LOADER_CA_CERTS', None,
              'The filename of CA certificates in PEM format', 'HTTP Loader')

Config.define('HTTP_LOADER_VALIDATE_CERTS', None,
              'Validate the server’s certificate for HTTPS requests',
              'HTTP Loader')

Config.define('HTTP_LOADER_CLIENT_KEY', None, 'The filename for client SSL key',
              'HTTP Loader')

Config.define('HTTP_LOADER_CLIENT_CERT', None,
              'The filename for client SSL certificate', 'HTTP Loader')

Config.define('HTTP_LOADER_CURL_ASYNC_HTTP_CLIENT', False,
...
Config.define(
    ...
    'Indicates whether thumbor should store the signing key '
    'for each image in the file storage. '
    'This allows the key to be changed and old '
    'images to still be properly found', 'File Storage')

# FILE STORAGE OPTIONS
Config.define('FILE_STORAGE_ROOT_PATH',
...
Config.define('MEMCACHE_STORAGE_SERVERS', ['localhost:11211'],
              'List of Memcache storage server hosts', 'Memcache Storage')

# MIXED STORAGE OPTIONS
Config.define(
    'MIXED_STORAGE_FILE_STORAGE', 'thumbor.storages.no_storage',
    'Mixed Storage file storage. This must be the full name '
    'of a python module (python must be able to import it)', 'Mixed Storage')
Config.define(
    'MIXED_STORAGE_CRYPTO_STORAGE', 'thumbor.storages.no_storage',
    'Mixed Storage signing key storage. This must be the full '
    'name of a python module (python must be '
    'able to import it)', 'Mixed Storage')
Config.define(
    'MIXED_STORAGE_DETECTOR_STORAGE', 'thumbor.storages.no_storage',
    'Mixed Storage detector information storage. '
    'This must be the full name of a python module (python '
...
Config.define('PROFILE_DETECTOR_CASCADE_FILE', 'haarcascade_profileface.xml',
...
Config.define('JPEGTRAN_PATH', '/usr/bin/jpegtran',
              'Path for the jpegtran binary', 'Optimizers')

Config.define('FFMPEG_PATH', '/usr/local/bin/ffmpeg',
...
# RESULT STORAGE
Config.define('RESULT_STORAGE_EXPIRATION_SECONDS', 0,
              'Expiration in seconds of generated images in the result storage',
              'Result Storage')  # Never expires
Config.define('RESULT_STORAGE_FILE_STORAGE_ROOT_PATH',
...
Config.define('SQS_QUEUE_KEY_SECRET', None, 'AWS key secret',
              'Queued SQS Detector')
Config.define('SQS_QUEUE_REGION', 'us-east-1', 'AWS SQS region',
              'Queued SQS Detector')
...
Config.define('ERROR_FILE_NAME_USE_CONTEXT', False,
...
def format_value(value):
    'formats values for the configuration'
